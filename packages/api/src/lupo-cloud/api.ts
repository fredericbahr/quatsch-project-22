...
export const LUPOAirMetricControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [from] Filter for time
         * @param {string} [labels] Filter for label contents
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        readMetric: async (metric: ILupoAirMetric, from?: string, labels?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const LUPOAirMetricControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async readMetric(metric: ILupoAirMetric, from?: string, labels?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ILupoMeasuringData>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.readMetric(metric, from, labels, options);
...
export const LUPOAirMetricControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        readMetric(metric: ILupoAirMetric, from?: string, labels?: string, options?: any): AxiosPromise<Array<ILupoMeasuringData>> {
            return localVarFp.readMetric(metric, from, labels, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class LUPOAirMetricControllerApi extends BaseAPI {
     ...
     */
    public readMetric(metric: ILupoAirMetric, from?: string, labels?: string, options?: AxiosRequestConfig) {
        return LUPOAirMetricControllerApiFp(this.configuration).readMetric(metric, from, labels, options).then((request) => request(this.axios, this.basePath));
    }
}
