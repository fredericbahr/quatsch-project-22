...
The component fetches every rdf triple of the a `<urn:domain>` class, maps it to an internal representation and checks if previous NER annotations in the question fuzzy match a domain instance.
