 ...
 */
export const completeRequestHandler = async (req: RasaRequest, res: RasaResponse) => {
  const enforcedLUBWData: Partial<ILUBWData> = { [ILUBWDataKey.Calculation]: CALCULATION_TYPE.Average };
