...
export class LUBWDataTransformationService {
   ...
   */
  public static getTransformedLUBWData(annotations: Array<IQanaryAnnotation>): Partial<ILUBWData> {
   ...
   */
  private static transformAndMergeWithDefaultLUBWData(filteredAnnotations: IFilteredAnnotations): Partial<ILUBWData> {
