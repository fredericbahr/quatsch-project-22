...
[source,dotenv]
----
include::../../.env[tags=qanary-pipeline;qanary-component-core;qanary-component-time]
----
...
For example, a component that leaves an annotation of the type AnnotationOfQuestionLanguage is https://github.com/WDAqua/Qanary-question-answering-components/tree/master/qanary-component-LD-Shuyo[LD-Shuyo].
