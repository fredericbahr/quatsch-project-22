 ...
 */
const generateTrainingData = (question, { station, measurand, representation, calculation }) => {
  ...
  questionsStationMeasurand.forEach((question) => {
    stations.forEach((station) => {
      measurands
        ...
        .forEach((measurand) => {
          const { trainingDataNer, trainingDataNlu } = generateTrainingData(question, { station, measurand });
        ...
        .forEach((measurand) => {
          representations
            ...
            .forEach((representation) => {
              const { trainingDataNer, trainingDataNlu } = generateTrainingData(question, {
                station,
                measurand,
                representation,
              });
 ...
 */
const generateCsvEntryString = (entry) => {
