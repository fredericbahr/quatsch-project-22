...
A language classification component.

.Example Question:
[source,text]
----
Wie ist der Ozonwert in Ulm am 23.01.2023?
└───────────────────┬────────────────────┘
         AnnotationOfQuestionLanguage
----
// end::excerpt[]
https://github.com/WDAqua/Qanary-question-answering-components/tree/master/qanary-component-LD-Shuyo[Read more]
...
[source,yaml]
----
include::../../docker-compose.yml[tags=preamble;qanary-pipeline;qanary-component-ld-shuyo;networks]
----
...
[source,dotenv]
----
include::../../.env[tags=qanary-pipeline;qanary-component-core;qanary-component-ld-shuyo]
----
...
For the HTTP query `Wie ist der Ozonwert in Ulm am 23.01.2023?` there are the following found annotations in the SPARQL query
